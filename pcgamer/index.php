...
<head>
   ...
   <title>PC Gamer References | Referencias</title>
...
<section class="all-posts">
   ...
   <div class="heading"><h1>Referencias</h1></div>
   ...
   <div class="box">
      ...
      <a href="view_post.php?get_id=<?= $post_id; ?>" class="inline-btn">Ver referencias</a>
   </div>
   <?php
      }
   }else{
